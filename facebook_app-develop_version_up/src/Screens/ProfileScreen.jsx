...
function ProfileScreen({ navigation, route }) {
  ...
  const handleSetRequestFriend = async () => {
    try {
      const data = await userService.setRequestFriend(userId);
      console.log(data);
    } catch (error) {
      console.log(error);
    }
  ...
  const handleGetData = () => {
    postService
      .getListPostByUserId(userId ? userId : user.id)
      .then((result) => {
    ...
    userService
      .getUserFriends(userId ? userId : user.id, 0, 0)
      .then((result) => {
      ...
      >
          ...
          <View style={styles.avatar}>
            ...
            <View style={{ flexDirection: "row", width: 0.9 * width }}>
              {userId ? (
                <>
                  {userInfors?.is_friend === "true" ? (
                    ...
                    <TouchableOpacity
                      onPress={handleSetRequestFriend}
                      style={styles.editInfor}
                    >
                      <View style={styles.editInfor}>
                        <FontAwesome5
              ...
              <TouchableOpacity
                ...
                onPress={() => navigation.navigate("setting", {targetUserId: userId})}
              >
                <View>
        ...
        <View style={styles.secondView}>
          ...
          <View style={styles.rowInfor}>
            ...
            <Text style={styles.hardTextAddress}>Học tại</Text>
          ...
          <View style={styles.rowInfor}>
            <MaterialCommunityIcons name="school" size={27} color="#909698" />
            <Text style={styles.hardTextAddress}>Từng học tại</Text>
            <Text style={styles.data}>Đại học Bách Khoa Hà Nội</Text>
          </View>
          <View style={styles.rowInfor}>
            <MaterialCommunityIcons name="school" size={27} color="#909698" />
            <Text style={styles.hardTextAddress}>Đã học tại</Text>
            <Text style={styles.data}>THPT Thanh Thủy</Text>
          </View>
        ...
        <View style={styles.thirdView}>
          ...
          >
            <View style={styles.thinking}>
              <Image
                source={
                  (userId ? !userInfor?.avatar : !userInfors.avatar)
                    ? require("../../assets/images/default_avatar.jpg")
                    : { uri: userId ? userInfor?.avatar : userInfors?.avatar }
                }
              ...
              {!userId ? (
                ...
                <>
                  <Text style={styles.thinkText}>
                    Viết gì đó cho {userInfors?.username}
                  </Text>
